...
from engine import *
from models import build_t
# from models import build_s
...
def get_args_parser():
    ...
    parser.add_argument('--set_cost_density', type=float, default=1.0,
                        help="Relative weight of the L2 error of the density maps in the matching cost")
    ...
    # dataset parameters
    parser.add_argument('--dataset_file', default='shanghaitech_part_A')
    parser.add_argument('--data_root', default=r'D:\dataset',
                        help='path where the dataset is')

    parser.add_argument('--output_dir', default=r'D:\PaperCode\P2PNet\out',
                        help='path where to save, empty for no saving')
    parser.add_argument('--checkpoints_dir', default=r'D:\PaperCode\P2PNet\checkpoints',
                        help='path where to save checkpoints, empty for no saving')
    parser.add_argument('--tensorboard_dir', default='./runs',
                        help='path where to save, empty for no saving')
    parser.add_argument('--teacher_model_path', default=r'D:\PaperCode\P2PNet\weights\SHTechA.pth',
                        help='Path to the pretrained teacher model weights')
...
def main(args):
    ...
    model, criterion = build_t(args, training=True)
    # move to GPU
    model.to(device)
    criterion.to(device)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # checkpoint_latest_path = os.path.join(args.checkpoints_dir, 'best_mae.pth')
        torch.save({
